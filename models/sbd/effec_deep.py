...
from isegm.data.OtherDataset import  MycdatasetsUsedToTrain
...
def train(model, cfg, model_cfg, start_epoch=0):
    ...
    #     points_sampler=points_sampler
    # )
    trainset = MycdatasetsUsedToTrain("./datasets/mycdata/train",
                                          augmentator=train_augmentator,
                                          points_from_one_object=False,
                                          input_transform=model_cfg.input_transform,
                                          # min_object_area=80,
    ...
    valset = MycdatasetsUsedToTrain("./datasets/mycdata/test",
                                        augmentator=val_augmentator,
                                        num_masks=num_masks,
                                        points_from_one_object=False,
                                        input_transform=model_cfg.input_transform,
