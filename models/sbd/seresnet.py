...
from isegm.data.grabcut import GrabCutDataset_usedToTrain
...
def init_model(cfg):
    ...
    # 获取deeplabmodle
    model = get_deeplab_model_seresnet(backbone='se_resnet50', deeplab_ch=128, aspp_dropout=0.20)
...
def train(model, cfg, model_cfg, start_epoch=0):
    ...
    # trainset = GrabCutDataset_usedToTrain(cfg.GRABCUT_PATH,
    #                                       augmentator=train_augmentator,
    #                                       points_from_one_object=False,
    #                                       input_transform=model_cfg.input_transform,
    #                                       # min_object_area=80,
    ...
    #                                       )
    #
    # valset = GrabCutDataset_usedToTrain(cfg.GRABCUT_PATH,
    #                                     augmentator=val_augmentator,
    #                                     num_masks=num_masks,
    #                                     points_from_one_object=False,
    #                                     input_transform=model_cfg.input_transform,
