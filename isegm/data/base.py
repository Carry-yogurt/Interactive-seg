...
class ISDataset(torch.utils.data.dataset.Dataset):
    def __init__(self,
        ...
        self.image_rescale = self.scale_func
    ...
    def __getitem__(self, index):
        ...
        sample = self.augment_sample(sample, use_zoom_in=use_zoom_in)  ## 在这里卡住了了
