...
from isegm.model.modeling.se_resnet import Se_ResNetBackbone
from isegm.model import ops

# 特征提取
class DeepLabV3Plus_seResnet(nn.Module):
    def __init__(self, backbone='se_resnext_50', norm_layer=nn.BatchNorm2d,
                 backbone_norm_layer=None,
                 ch=256,
                 project_dropout=0.5,
                 inference_mode=False,
                 **kwargs):
        super(DeepLabV3Plus_seResnet, self).__init__()
        ...
        self.backbone = Se_ResNetBackbone(backbone=self.backbone_name, pretrained_base=False,
