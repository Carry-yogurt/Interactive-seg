...
def parse_args():
    ...
    parser.add_argument('--thresh', type=float, required=False, default=0.45,
...
def main():
    ...
    model = utils.load_is_model(checkpoint_path, args.device, norm_radius=args.norm_radius,backbone = "seres")
    # state_dict = torch.load("./weights/156coco.pth", map_location="cuda")
    # model = SegFormerModel_b0_new_04_fpn().to("cuda")
    ...
    for dataset_name in args.datasets.split(','):
        ...
        dataset_results = evaluate_dataset(dataset, predictor, pred_thr=args.thresh,
                                           ...
                                           max_clicks=args.n_clicks,k=args.k,th=args.th)
